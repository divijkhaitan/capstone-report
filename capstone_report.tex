...
\begin{document}
    ...
    \begin{titlepage}
        \centering
        \vspace*{1in}
        {\Huge\bfseries Capstone Thesis - A New Framework for Evaluating the Robustness of Deep Neural Networks \par}
        \vspace{1.5in}
    ...
    \section{Results}
        ...
        \subsection{Modelling Significant Activations as Bernoulli Distributions}
            ...
            \subsubsection{Intra-Dataset Separation: ID vs OOD datasets on Imagenet}
                ...
                % KL Matrix In Distribution InceptionV3 (untrained, trained, random labels)
                \begin{figure}[H]
                    \centering
                    \begin{minipage}{0.3\textwidth}
                        \centering
                        \includegraphics[width=\textwidth]{new/inception_v3_untrained_imgr_out/out_matrices/inception_v3_kl_matrix.png}
                    \end{minipage}\hfill
                    \begin{minipage}{0.3\textwidth}
                        \centering
                        \includegraphics[width=\textwidth]{new/inception_v3_imgr_out/out_matrices/inception_v3_kl_matrix.png}
                    \end{minipage}\hfill
                    \begin{minipage}{0.3\textwidth}
                        \centering
                        \includegraphics[width=\textwidth]{new/inception_v3_imgr_out_random_labels/out_matrices/inception_v3_kl_matrix.png}
                    \end{minipage} 
                    \caption{KL divergences between different classes for the untrained (left), trained (middle) and random labels (right) classes of InceptionV3 on imagenet. These are the values for the distributions for the last layer}
                    \label{fig:kl_divergences_inceptionv3}
                \end{figure}
                ...
                \begin{figure}[H]
                    ...
                    \begin{minipage}{0.3\textwidth}
                        \centering
                        \includegraphics[width=\textwidth]{new/inception_v3_untrained_r/out_matrices/inception_v3_kl_matrix.png}
                    \end{minipage}\hfill
                    \begin{minipage}{0.3\textwidth}
                        \centering
                        \includegraphics[width=\textwidth]{new/inception_v3_r/out_matrices/inception_v3_kl_matrix.png}
                    \end{minipage}\hfill
                    \begin{minipage}{0.3\textwidth}
                        \centering
                        \includegraphics[width=\textwidth]{new/inception_v3_r_random_labels/out_matrices/inception_v3_kl_matrix.png}
                    \end{minipage}
                    
                    \caption{KL divergences between different classes for the untrained (left), trained (middle) and random labels (right) classes of InceptionV3 on the OOD dataset imagenet-r. These are the values for the distributions for the last layer}
                    \label{fig:kl_divergences_inceptionv3_imagenet-r}
                \end{figure}
        ...
        \subsection{The Effect of Adversarial Attacks on Probability Distributions}
            ...
            \begin{figure}[H]
                ...
                \begin{minipage}{\textwidth}
                    \centering
                    \includegraphics[width=\textwidth]{new/inception_v3_imgr_r_log_prob_analysis_adv.png}
                    \subcaption{Last Layer}
                \end{minipage}%
                \caption{Log Probabilities under an Adversarial Attack on Inception V3 for ImageNet}
                \label{fig:adv_log_probs_inceptionv3}
            \end{figure}                
            

            To test this hypothesis, we compared the norms of adversarially attacked inputs to clean inputs and the results are attached below. There is a clear cut separation in between the norms of both datasets, which lends credence to the idea that adversarially attacked inputs push the embedding closer to the null space of the liner layers. Note that this is with a much weaker PGD attack (10 iterations), and the shift is extremely noticable. InceptionV3 has the opposite behaviour, with the adversarial inputs having a larger norm than the clean inputs. This may suggest that the nature of the adversarial attack is extremely different for different architectures, and it is not immediately clear what that difference is. 
            \begin{figure}[H]
                \centering
                \begin{minipage}{\textwidth}
                    \centering
                ...
                \end{minipage}%
                \caption{Change in Embedding Norms under an Adversarial Attack on Small AlexNet for CIFAR10}
                \label{fig:adv_norms}
            \end{figure}                
            ...
            \begin{figure}[H]
                ...
                \begin{minipage}{\textwidth}
                    \centering
                    \includegraphics[width=\textwidth]{new/inception_v3_activation_norm_comparison_layer_index_-1.png}
                    \subcaption{Last Layer}
                \end{minipage}%
                \caption{Change in Embedding Norms under an Adversarial Attack on Inception V3 for ImageNet}
                \label{fig:adv_norms_inceptionv3}
            \end{figure}                
