...
\begin{document}
    ...
    \section{Introduction}
        ...
        \subsection{Summary of Contributions}
            ...
            \begin{itemize}
                ...
                \item 
                    Extracting distributions from trained networks to address the problem of out-of-distribution data in a principled manner 
                \item 
    ...
    % \section{Entropies in Between Classes}
        ...
        \subsection{Log Probabilities for OOD detection}
            ...
            \begin{itemize}
                ...
                \item 
                    The posterior probability of having observed an activation of an image $x$ given that it comes from a dataset $Y$, i.e. $p(f(x)| x \sim Y)$ across the different dataset choices $Y$. Y here is a multivariate bernoulli distribution. Separation of different datasets under this score would make this a good metric for out-of-distribution detection. 
            \end{itemize}
            Tiny Imagenet needs to have a mapping to CIFAR10 crafted by hand. The mapping decided by us can be found in Appendix A. 
    ...
    \section{Results}
        ...
        \subsection{Modelling Significant Activations as Bernoulli Distributions}
            ...
            \subsubsection{Inter-Dataset Separation: CIFAR10, TinyImagenet, SVHN, CIFAR10.1}
                The goal of this is to quantify the shift in distribution across different validation sets. We measured various distances between the aggregate distributions and got the following results 
                ...
                \begin{figure}[H]
                    ...
                    \begin{minipage}{0.45\textwidth}
                        ...
                        \subcaption{KL Divergence of different datasets from CIFAR10}
                    \end{minipage}
                    
                    \begin{minipage}{0.45\textwidth}
                        \centering
                        \includegraphics[width=\textwidth]{new/consolidated_plots/inter_dist/ref_to_other_overall.png}
                        \subcaption{Intersection distance of different datasets from CIFAR10}
                    \end{minipage}
                \end{figure}
